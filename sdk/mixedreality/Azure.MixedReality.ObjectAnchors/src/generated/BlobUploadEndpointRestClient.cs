...
namespace Azure.MixedReality.ObjectAnchors
{
    internal partial class BlobUploadEndpointRestClient
    {
        ...
        public async Task<ResponseWithHeaders<UploadLocation, BlobUploadEndpointGetHeaders>> GetAsync(Guid accountId, string xMrcCv = null, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        UploadLocation value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = UploadLocation.DeserializeUploadLocation(document.RootElement);
        ...
        /// <param name="xMrcCv"> The client request correlation vector, which should be set to a new value for each request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<UploadLocation, BlobUploadEndpointGetHeaders> Get(Guid accountId, string xMrcCv = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetRequest(accountId, xMrcCv);
